...
/// WSL detection. The implementation lives in `agent-tui-tty-utils` (the shared
...
pub use agent_tui_tty_utils::is_wsl;
...
// tests live with the implementation in `agent-tui-tty-utils`.

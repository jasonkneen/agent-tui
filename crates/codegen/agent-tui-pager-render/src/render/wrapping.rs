...
///
/// The selection layer's stricter, style-aware twin lives in agent-tui-pager
...
mod tests {
    ...
    fn real_markdown_link_underline_does_not_leak_after_wrap() {
        ...
        let (out, _) = agent_tui_markdown::render_markdown_ratatui_full(md, md_style, true, None);

...
//!
//! Disk writes live in `agent_tui_shell::util::config::set_<field>()`.
...
use agent_tui_shared::ui_config::UiConfig;
...
fn load_bool_from_effective_config(key: &str, default: bool) -> bool {
    let root = match agent_tui_config::load_effective_config_disk_only() {
        Ok(r) => r,

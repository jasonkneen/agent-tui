...
impl TerminalContext {
    ...
    pub fn telemetry_snapshot(&self) -> agent_tui_telemetry::events::TerminalTelemetry {
        ...
        agent_tui_telemetry::events::TerminalTelemetry {
            ...
            clipboard_native_tool: agent_tui_shared::clipboard::native_tool_name().to_owned(),
            clipboard_data_control: crate::clipboard::wayland_data_control_label().to_owned(),
        }
    }

    /// Extract terminal info for feedback submissions.
    pub fn feedback_info(&self) -> agent_tui_shared::session::FeedbackTerminalInfo {
        use agent_tui_shared::session::FeedbackTerminalInfo;
        ...
        FeedbackTerminalInfo {
            ...
            clipboard_native_tool: Some(agent_tui_shared::clipboard::native_tool_name().to_owned()),
...
/// `agent-tui-pager-pty-harness/src/pty.rs` (test-env hygiene — the PTY

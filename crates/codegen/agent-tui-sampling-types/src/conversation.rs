...
// engine in `crates/common/agent-tui-compaction` operate over grok-build's
...
impl agent_tui_compaction::CompactionItem for ConversationItem {
    fn role(&self) -> agent_tui_compaction::CompactionRole {
        use agent_tui_compaction::CompactionRole;
    ...
    fn attachment_refs(&self) -> Vec<agent_tui_compaction::CompactionFileRef> {
...
impl agent_tui_compaction::CompactionItemFactory for ConversationItem {
...
/// ([stream/messages.rs:340](crates/codegen/agent-tui-sampler/src/stream/messages.rs))
...
///
/// This is `pub` so downstream crates (`agent-tui-shell`) can re-use it
...
impl From<ChatResponseMessage> for ConversationItem {
    fn from(msg: ChatResponseMessage) -> Self {
        ...
        // ([crates/codegen/agent-tui-sampler/src/stream/chat_completions.rs])
...
/// ([crates/codegen/agent-tui-sampler/src/stream/messages.rs]) instead
...
mod compaction_item_bridge_tests {
    use super::*;
    use agent_tui_compaction::{CompactionItem, CompactionItemFactory, CompactionRole};

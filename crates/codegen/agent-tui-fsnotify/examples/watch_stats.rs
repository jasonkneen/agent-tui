...
//! cargo run --release -p agent-tui-fsnotify --example watch_stats -- gen js /tmp/js-repo
//! GROK_FSNOTIFY_PER_DIR=0 cargo run --release -p agent-tui-fsnotify --example watch_stats -- run /tmp/js-repo 5
//! GROK_FSNOTIFY_PER_DIR=1 cargo run --release -p agent-tui-fsnotify --example watch_stats -- run /tmp/js-repo 5
//! ```
//!
...
use agent_tui_fsnotify::{FsConfig, FsEventSource};

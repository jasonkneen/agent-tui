//! Public event types — the wire contract for `agent-tui-fsnotify`.
//!
...
//! translator (in `agent-tui-workspace`) maps these to
...
/// Aligned with `agent_tui_workspace_types::FsEventKind` (identity map at

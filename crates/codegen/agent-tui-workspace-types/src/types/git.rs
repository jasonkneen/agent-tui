...
//! `agent_tui_shell::session::git` and `agent_tui_shell::extensions::git`
...
/// VCS kind.
///
/// TODO(workspace): align with `agent_tui_shell::session::git::VcsKind`.

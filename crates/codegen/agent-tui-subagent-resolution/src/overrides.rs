...
//!
//! Extracted from `agent-tui-shell/src/agent/subagent/` `resolve_effective_overrides()`.
...
mod tests {
    use super::*;
    use agent_tui_tools::implementations::grok_build::task::types::ModelOverrideProvenance;

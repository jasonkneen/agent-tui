...
use std::path::Path;
use agent_tui_agent::config::{AgentDefinition, IsolationMode};
use agent_tui_agent::plugins::PluginRegistry;
use agent_tui_agent::prompt::context::{PromptAudience, PromptContext};
...
pub async fn render_subagent_initial_user_message(
    ...
    let agents_md_files = agent_tui_agent::prompt::agents_md::read_agents_config_with_paths(

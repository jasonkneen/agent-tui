...
//! `agent_tui_sampling_types::SamplingConfig` so that the sampler crate
...
/// submit.
///
/// # Construction in `agent-tui-shell`
///
...
/// composing chat-state's `agent_tui_sampling_types::SamplingConfig`

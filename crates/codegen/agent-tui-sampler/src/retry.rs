...
use agent_tui_sampling_types::{SamplingError, is_retryable_api_status};
    ...
    fn zero_retry_budget_never_reuses_a_model_output_cap() {
        for err in [
            ...
            SamplingError::EmptyResponse {
                context: agent_tui_sampling_types::EmptyResponseContext {
                    reason: agent_tui_sampling_types::EmptyReason::NoVisibleContent,
                    had_reasoning: false,
                    content_len: 0,
                    tool_call_count: 0,

...
use agent_tui_sampling_types::error::{parse_error_bytes, try_parse_stream_error};
...
impl SamplingClient {
    ...
    pub async fn conversation_stream_responses(
        ...
        let extra_tools = agent_tui_sampling_types::extra_raw_tools(&request.hosted_tools);

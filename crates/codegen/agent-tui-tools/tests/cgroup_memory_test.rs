...
//! cargo test -p agent-tui-tools --test cgroup_memory_test -- --ignored --nocapture
//!
//! # If you need root:
//! sudo -E cargo test -p agent-tui-tools --test cgroup_memory_test -- --ignored --nocapture
//! ```
//!
...
use agent_tui_tools::computer::local::cgroup::{CgroupMemoryConfig, PROCESS_OOM_EXIT_CODE};
use agent_tui_tools::computer::types::{TerminalBackend, TerminalRunRequest, TerminalRunResult};

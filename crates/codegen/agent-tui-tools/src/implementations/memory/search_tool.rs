...
impl agent_tui_tool_runtime::Tool for MemorySearchImpl {
    type Args = MemorySearchInput;
    type Output = ToolOutput;

    fn id(&self) -> agent_tui_tool_protocol::ToolId {
        agent_tui_tool_protocol::ToolId::new("memory_search").expect("valid tool id")
    }
        ...
        let results = memory
            ...
            .map_err(|e| {
                agent_tui_tool_runtime::ToolError::execution(
                    agent_tui_tool_protocol::ToolId::new("memory_search").expect("valid"),

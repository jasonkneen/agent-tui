...
/// `cargo test -p agent-tui-shell e2e_real_typescript_language_server -- --ignored`
#[ignore]
#[tokio::test(flavor = "current_thread")]
...
///   cargo test -p agent-tui-tools e2e_real_roslyn_survives_editing -- --ignored --nocapture
/// ```
#[ignore]
#[tokio::test(flavor = "multi_thread")]

...
impl agent_tui_tool_runtime::ToolOutput for SchedulerDeleteOutput {}
...
impl agent_tui_tool_runtime::Tool for SchedulerDeleteTool {
    type Args = SchedulerDeleteInput;
    type Output = SchedulerDeleteOutput;

    fn id(&self) -> agent_tui_tool_protocol::ToolId {
        agent_tui_tool_protocol::ToolId::new("scheduler_delete").expect("valid tool id")
    }
    ...
    ) -> Result<SchedulerDeleteOutput, agent_tui_tool_runtime::ToolError> {

...
use dashmap::DashMap;
use agent_tui_file_utils::events::{Event, EventWriter, ToolCompletedSource, ToolOutcome};
use agent_tui_file_utils::queue::UploadQueueStats;
use agent_tui_tool_protocol::{IdleWithholdReason, ToolServerLifecycleStatus, ToolServerStatusPayload};
...
pub(crate) const PRESENCE_ACTIVITY_WINDOW_MS: u64 =
    agent_tui_workspace_types::rpc::presence::PRESENCE_ACTIVITY_WINDOW_MS;

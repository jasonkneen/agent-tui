...
pub struct WorkspaceSession {
    ...
    ///
    /// [`HunkTrackerActor`]: agent_tui_hunk_tracker::HunkTrackerActor
...
impl WorkspaceSession {
    ...
    pub(crate) async fn toolset_terminal_is_session_owned(&self) -> bool {
        ...
        match res.get::<agent_tui_tools::types::resources::Terminal>() {
...
pub struct WorkspaceShared {
    ...
    pub(crate) events: tokio::sync::broadcast::Sender<agent_tui_workspace_types::WorkspaceEvent>,
    pub(crate) respect_gitignore: bool,
    pub(crate) memory_config: Option<MemoryConfig>,
    pub(crate) hook_registry: Arc<parking_lot::RwLock<agent_tui_hooks::discovery::HookRegistry>>,
    pub(crate) hook_load_errors: Vec<agent_tui_hooks::error::HookError>,
    ...
    pub(crate) activity_notify_handle:
        arc_swap::ArcSwap<Option<agent_tui_tools::notification::types::ToolNotificationHandle>>,
    ...
    pub(crate) lsp: Option<std::sync::Arc<dyn agent_tui_tools::implementations::lsp::LspBackend>>,
...
impl WorkspaceShared {
    ...
    pub fn subscribe_events(
        &self,
    ) -> tokio::sync::broadcast::Receiver<agent_tui_workspace_types::WorkspaceEvent> {
...
pub(crate) fn get_or_open_session_writer(
    ...
    let create = agent_tui_config::create_dir_all_owner_only(&dir);
    agent_tui_config::set_dir_owner_only(&sessions_root);
    if let Err(e) = create {
        tracing::warn!(

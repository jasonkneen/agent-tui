//! AcpFsAdapter: implements `agent-tui-tools::AsyncFileSystem` using ACP gateway calls.
//!
//! This adapter enables file tool execution over ACP (remote filesystem).
//! It translates agent-tui-tools' `AsyncFileSystem` trait into ACP protocol calls:

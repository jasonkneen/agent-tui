...
// its wire types live in `agent_tui_workspace_types::rpc::fs` (the `ClientFs*`
...
pub use agent_tui_workspace_types::rpc::fs::FsReadEncoding;
...
pub use agent_tui_workspace_types::rpc::search::{ClientId, ContentSearchRequest, TargetClientId};

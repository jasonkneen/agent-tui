...
use agent_tui_tools::implementations::grok_build::scheduler::interval::interval_to_human;
use agent_tui_tools::implementations::grok_build::scheduler::types::{
    SchedulerCommand, SchedulerHandle,
};
use agent_tui_tools::registry::types::FinalizedToolset;
use agent_tui_tools::types::resources::Terminal;
...
) -> Vec<agent_tui_workspace_types::rpc::workspace::BackgroundTaskSummaryWire> {
    use agent_tui_tools::computer::types::TaskKind;
    use agent_tui_tools::types::resources::Terminal;
    use agent_tui_tools::types::tool::ToolKind;
    use agent_tui_workspace_types::rpc::workspace::BackgroundTaskSummaryWire;
    let terminal = {
...
async fn list_session_todos(
    toolset: &agent_tui_tools::registry::types::FinalizedToolset,
) -> Vec<agent_tui_workspace_types::rpc::workspace::TodoSummaryWire> {
    use agent_tui_tools::implementations::grok_build::todo::{TodoState, TodoStatus};
    use agent_tui_tools::types::resources::State;
    use agent_tui_workspace_types::rpc::workspace::TodoSummaryWire;
    let res = toolset.resources.lock().await;
...
impl WorkspaceRpcHandler {
    ...
    async fn dispatch(
        ...
        use agent_tui_workspace_types::rpc::git::{GitBranchInfoReq, GitMetadataReq};
        use agent_tui_workspace_types::rpc::presence::PresenceNoteReq;
        use agent_tui_workspace_types::rpc::search::FuzzyStatusReq;
        use agent_tui_workspace_types::rpc::skills::DiscoverPluginsReq;
        use agent_tui_workspace_types::rpc::workspace::{
        ...
        use agent_tui_workspace_types::rpc::worktree::WorktreeCreateSyncReq;
        ...
        match method {
            <WorkspaceInfoReq as WorkspaceRpc>::METHOD => {
                ...
                let info = WorkspaceInfo {
                    ...
                    version: Some(agent_tui_version::VERSION.to_owned()),
                };
...
mod tests {
    ...
    async fn dispatch_workspace_info_reports_server_version() {
        use agent_tui_workspace_types::rpc::workspace::{WorkspaceInfo, WorkspaceInfoReq};
        let handler = WorkspaceRpcHandler::new(make_handle());
        let value = handler
            .dispatch(
                <WorkspaceInfoReq as WorkspaceRpc>::METHOD,
        ...
        assert_eq!(Some(agent_tui_version::VERSION.to_owned()), info.version);
    }
    #[tokio::test]
    ...
    async fn list_background_tasks_rpc_stays_truthful_across_rebinds() {
        ...
        use agent_tui_workspace_types::rpc::workspace::ListBackgroundTasksResponse;
        let handle = make_handle();
        ...
        let read_only = ToolServerConfig {
            tools: vec![tc(
                "GrokBuild:read_file",
                Some(agent_tui_tools::types::tool::ToolKind::Read),
            )],
    ...
    async fn dispatch_knows_every_typed_method() {
        ...
        let methods = [
            ...
            <GetRewindPointsReq as WorkspaceRpc>::METHOD,
            <RewindToReq as WorkspaceRpc>::METHOD,
            <agent_tui_workspace_types::rpc::presence::PresenceNoteReq as WorkspaceRpc>::METHOD,
            <HookRegistryReq as WorkspaceRpc>::METHOD,
            <LoadProjectConfigReq as WorkspaceRpc>::METHOD,
            <LoadPermissionsReq as WorkspaceRpc>::METHOD,
            <LoadEnvrcReq as WorkspaceRpc>::METHOD,
    ...
    async fn dispatch_stamps_client_rpc_activity_for_mutations_only() {
        ...
        use agent_tui_workspace_types::rpc::workspace::DropSessionReq;
        use agent_tui_tool_protocol::IdleWithholdReason;
        let handler = WorkspaceRpcHandler::new(make_handle());

...
use agent_tui_tools::implementations::grok_build::web_fetch::{
...
fn permission_mode_artifact_str(mode: agent_tui_telemetry::enums::PermissionMode) -> &'static str {
    use agent_tui_telemetry::enums::PermissionMode;
    match mode {
            ...
            match cmd {
                ...
                PermissionCommand::Request {
                    ...
                    if matches!(&access, AccessKind::Bash(_))
                        && agent_tui_sandbox::should_auto_allow_bash()

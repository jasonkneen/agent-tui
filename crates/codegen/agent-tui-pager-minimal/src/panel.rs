...
use agent_tui_pager::views::extensions_modal::{ExtensionsTab, TabDataState};
use agent_tui_pager::views::modal::ActiveModal;
use agent_tui_pager::views::picker::{self, PickerEntry, PickerField, PickerHitAreas, PickerRow};
...
mod tests {
    use super::*;
    use ratatui::layout::Rect;
    use agent_tui_pager::views::extensions_modal::ExtensionsModalState;
    use agent_tui_pager::views::mcps_modal::{McpServerDisplayStatus, McpServerInfo, McpWireSource};
    ...
    fn session_entry(id: &str) -> agent_tui_pager::app::app_view::SessionPickerEntry {
        agent_tui_pager::app::app_view::SessionPickerEntry {
            id: id.into(),
            summary: id.into(),
    ...
    fn with_resume(entries: Vec<agent_tui_pager::app::app_view::SessionPickerEntry>) -> AgentView {
        let mut a = agent();
        a.active_modal = Some(ActiveModal::SessionPicker {
            ...
            window: agent_tui_pager::views::modal_window::ModalWindowState::new(),
            content_results: None,
            content_loading: false,
            deep_search_seq: 0,
            source_filter: agent_tui_pager::views::session_picker::SourceFilter::default(),
            pending_delete: None,
            entries_query: None,
        });
        a

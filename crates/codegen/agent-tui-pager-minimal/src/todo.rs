...
use agent_tui_shell::tools::TodoStatus;
    ...
    let mut lines: Vec<Line<'static>> = todos
        ...
        .map(|t| {
            let (glyph, style) = match t.status {
                ...
                TodoStatus::Completed => (agent_tui_pager::glyphs::check_mark(), theme.muted()),
                TodoStatus::Cancelled => (
                    agent_tui_pager::glyphs::ballot_x(),
...
mod tests {
    ...
    use agent_tui_shell::tools::{TodoItem, TodoPriority};

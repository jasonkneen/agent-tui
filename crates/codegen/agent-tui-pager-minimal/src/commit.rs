...
use agent_tui_pager::scrollback::blocks::ToolCallBlock;
use agent_tui_pager::scrollback::entry::{EntryId, ScrollbackEntry};
...
mod tests {
    ...
    fn terminal_native_lock_paints_only_native_colors() {
        use ratatui::buffer::Buffer;
        use agent_tui_pager::theme::cache as theme_cache;
        ...
        impl Drop for LockReset {
            fn drop(&mut self) {
                agent_tui_pager::theme::cache::set_terminal_native_lock(false);
            }
        }
    ...
    fn committed_edit_keeps_diff_line_backgrounds() {
        ...
        use ratatui::layout::Rect;
        use similar::ChangeTag;
        use agent_tui_pager::diff::DiffLine;

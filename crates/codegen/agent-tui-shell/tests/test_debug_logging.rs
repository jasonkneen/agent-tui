...
//! ```bash
//! cargo test -p agent-tui-shell --test test_debug_logging -- --ignored
//! ```
...
/// assert it carries first-party (`agent_tui`) content. Panics with the captured

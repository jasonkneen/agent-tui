...
use agent_tui_shell::auth::{AuthManager, AuthMode, GrokAuth, GrokComConfig};
use agent_tui_shell::heap_profile::{
...
use agent_tui_test_support::{EnvGuard, MockInferenceServer};
use agent_tui_version::TEST_VERSION_ENV;
...
fn assert_storage_auth(uploads: &[agent_tui_test_support::mock_server::StorageUpload]) {
    for u in uploads {
        assert_eq!(

...
use agent_tui_config::signed_policy;
...
async fn offline_team_switch_purges_sidecar_and_permits_new_team() {
    ...
    assert!(
        agent_tui_shell::config::managed_policy_compromised_for(&team_identity("team-b")),
    ...
    assert!(
        agent_tui_shell::config::is_managed_config_hard_stale_for(&team_identity("team-b")),

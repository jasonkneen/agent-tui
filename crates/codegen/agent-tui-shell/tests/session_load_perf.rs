...
//!
//! Run:
//!   cargo test -p agent-tui-shell --test session_load_perf -- --nocapture
//!   cargo test -p agent-tui-shell --test session_load_perf full_session_load_e2e -- --ignored --nocapture
...
use agent_tui_workspace::session::file_state::{FileSnapshot, FlexiblePath, RewindPoint};

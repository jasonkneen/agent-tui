...
pub fn signed_team_body(
    ...
    let payload = SignedPayload {
        ...
        fail_closed: requirements.is_some_and(agent_tui_config::fail_closed_flag_from_str),
...
pub fn team_identity(id: &str) -> agent_tui_shell::config::ServingIdentity {
    agent_tui_shell::config::ServingIdentity::Team(id.to_owned())
}

//! Shared helpers for agent-tui-shell integration tests.

use agent_tui_shell::sampling::{ApiBackend, Client, SamplerConfig};
...
pub mod leader {
    ...
    use agent_tui_test_support::leader::{LeaderFixture, LeaderStdioClient};
...
pub fn test_sampler_config(
    ...
    // Shell `Client` is `agent_tui_sampler::SamplingClient`, which takes a

...
use agent_tui_agent::prompt::skills::{
...
pub async fn handle(
    ...
    match args.method.as_ref() {
        "x.ai/skills/add" => {
            ...
            .await
            {
                agent_tui_telemetry::session_ctx::log_event(
                    agent_tui_telemetry::events::SkillAdded {
                        added_count: 0,
                        total_skills: 0,
                        success: false,
                    },
            ...
            agent_tui_telemetry::session_ctx::log_event(agent_tui_telemetry::events::SkillAdded {
        ...
        "x.ai/skills/remove" => {
            ...
            {
                agent_tui_telemetry::session_ctx::log_event(
                    agent_tui_telemetry::events::SkillRemoved { success: false },
                );
            ...
            agent_tui_telemetry::session_ctx::log_event(agent_tui_telemetry::events::SkillRemoved {
                success: true,
            });

//! Jujutsu extension handlers — delegates to [`agent_tui_workspace::session::jj`].

use agent_client_protocol as acp;

use super::{Empty, ExtResult, to_ext_response, to_ext_response_partial};
use agent_tui_workspace::session::git::{CommitData, StageData};
use agent_tui_workspace::session::jj;

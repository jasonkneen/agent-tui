...
pub async fn persist_models_default(
    value: Option<String>,
    reasoning_effort: Option<agent_tui_sampling_types::ReasoningEffort>,
) -> anyhow::Result<()> {
...
mod tests {
    ...
    use agent_tui_config::ConfigLayers;

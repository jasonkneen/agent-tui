...
use agent_tui_workflow::{PauseKind, PhaseMeta, WorkflowOutcome};
...
fn capped_pause_message(message: impl Into<String>) -> String {
    ...
    agent_tui_tools::util::truncate_str(&message, WORKFLOW_PAUSE_MESSAGE_MAX_BYTES).to_string()
}
    ...
    pub(crate) fn apply_outcome(
        ...
        match outcome {
            ...
            WorkflowOutcome::BudgetExceeded { message } => {
                ...
                let hint = if run.state.agents_used >= agent_tui_workflow::MAX_AGENT_BUDGET {

...
pub use agent_tui_telemetry::enums::PrCreationSource;
...
impl SessionSignalsHandle {
    ...
    pub(crate) fn snapshot_gcs_queue(&self, stats: &agent_tui_file_utils::queue::UploadQueueStats) {
...
pub(crate) fn merge_tightest_trigger(current: Option<String>, new: &[String]) -> Option<String> {
    agent_tui_sampling_types::doom_loop::DoomLoopSignal::tightest(
        current
            .iter()
            .map(String::as_str)

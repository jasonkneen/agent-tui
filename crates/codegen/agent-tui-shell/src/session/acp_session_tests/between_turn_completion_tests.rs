use agent_tui_tools::implementations::grok_build::task::types::SubagentCompletionSummary;
use agent_tui_tools::reminders::task_completion::format_between_turn_completions;

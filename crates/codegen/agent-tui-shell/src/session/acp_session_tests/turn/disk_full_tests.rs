...
use agent_tui_test_support::{MockInferenceServer, ScriptedResponse};
...
fn drain_gateway(mut rx: tokio::sync::mpsc::UnboundedReceiver<agent_tui_acp_lib::AcpClientMessage>) {

...
fn test_json_round_trip() {
    let ctx = agent_tui_agent::PromptContext {
        ..Default::default()
    };

    let json = serde_json::to_string_pretty(&ctx).unwrap();
    let loaded: agent_tui_agent::PromptContext = serde_json::from_str(&json).unwrap();
...
fn test_json_round_trip_via_filesystem() {
    ...
    let ctx = agent_tui_agent::PromptContext::default();
    ...
    let loaded: agent_tui_agent::PromptContext = serde_json::from_str(&read_json).unwrap();
...
fn test_canonical_artifacts_coexist() {
    ...
    let read_ctx: agent_tui_agent::PromptContext = serde_json::from_str(
...
fn test_corrupt_json_returns_error() {
    ...
    let result: Result<agent_tui_agent::PromptContext, _> = serde_json::from_str(&json);

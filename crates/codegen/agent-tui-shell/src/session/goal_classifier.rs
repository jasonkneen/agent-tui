...
use agent_tui_tools::implementations::grok_build::task::backend::{ChannelBackend, SubagentBackend};
...
pub(crate) fn build_subagent_trace_items(
    ...
    prompt: &str,
    output: &str,
) -> Vec<agent_tui_sampling_types::conversation::ConversationItem> {
    use agent_tui_sampling_types::conversation::{ConversationItem, ToolCall};
...
pub(crate) struct ChannelSpawner {
    ...
    pub(crate) foreground_wait:
        Option<agent_tui_tools::implementations::grok_build::task::types::SubagentForegroundWait>,
...
mod tests {
    ...
    fn verifier_template_renders_per_agent_type_and_falls_back() {
        use agent_tui_tools::implementations::grok_build::task::types::SubagentTypeSummary;
        let mut tool_names = std::collections::HashMap::new();
        tool_names.insert(
            agent_tui_tools::types::tool::ToolKind::Read,
            "cursor_read".to_string(),
        );
        tool_names.insert(
            agent_tui_tools::types::tool::ToolKind::ListDir,
            "cursor_ls".to_string(),
        );
        tool_names.insert(
            agent_tui_tools::types::tool::ToolKind::Search,
        ...
        let grok = RoleToolNames::from_summary(&summary_with(&[
            (agent_tui_tools::types::tool::ToolKind::Read, "read_file"),
            (agent_tui_tools::types::tool::ToolKind::ListDir, "list_dir"),
            (agent_tui_tools::types::tool::ToolKind::Search, "grep"),
        ]))
    ...
    fn cold_and_resume_renders_are_symmetric_for_an_index() {
        let summary = summary_with(&[
            (agent_tui_tools::types::tool::ToolKind::Read, "cursor_read"),
            (agent_tui_tools::types::tool::ToolKind::ListDir, "cursor_ls"),
            (agent_tui_tools::types::tool::ToolKind::Search, "cursor_grep"),
        ]);

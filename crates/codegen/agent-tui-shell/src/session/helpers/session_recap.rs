...
use agent_tui_chat_state::{compaction_utils, estimate_conversation_tokens, estimate_item_tokens};
...
mod tests {
    ...
    fn main_turn_count_counts_real_users_only() {
        use std::sync::Arc;
        use agent_tui_sampling_types::{ContentPart, SyntheticReason, ToolCall, UserItem};
    ...
    fn mk_tool_call(id: &str, args: &str) -> agent_tui_sampling_types::ToolCall {
        use std::sync::Arc;

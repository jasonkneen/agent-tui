...
pub enum SideQuestionError {
    ...
    Sampling(#[from] agent_tui_sampling_types::SamplingError),
...
pub enum SessionCommand {
    ...
    RestorePlanApproval,
    GetToolOverrides {
        respond_to: oneshot::Sender<Option<agent_tui_sampling_types::ToolOverrides>>,
    },
    ...
    SetToolOverrides {
        overrides: agent_tui_sampling_types::ToolOverrides,
    },
    Prompt {
        prompt_id: String,
        ...
        tool_overrides_update: Option<agent_tui_sampling_types::ToolOverridesUpdate>,
    ...
    SetSessionModel {
        sampling_config: agent_tui_sampler::SamplerConfig,
        use_concise: bool,
    ...
    ReloadPlugins {
        registry: Option<std::sync::Arc<agent_tui_agent::plugins::PluginRegistry>>,
    },
    ...
    SnapshotToolDefinitions {
        respond_to: oneshot::Sender<Vec<agent_tui_sampling_types::ToolSpec>>,
    },
    ...
    KillBackgroundTask {
        task_id: String,
        respond_to: oneshot::Sender<Result<agent_tui_tools::types::KillOutcome, String>>,
    },
    DeleteScheduledTask {
        task_id: String,
    ...
    ListTasks {
        respond_to: oneshot::Sender<Option<Vec<agent_tui_tools::types::TaskSnapshot>>>,
    },
    ...
    PluginsList {
        respond_to:
            oneshot::Sender<Option<std::sync::Arc<agent_tui_agent::plugins::PluginRegistry>>>,
    },
    ...
    TakeHarnessTraceTurns {
        respond_to:
            oneshot::Sender<Vec<Vec<agent_tui_sampling_types::conversation::ConversationItem>>>,
    },

...
//! window containing a [`agent_tui_mcp::servers::McpClientEventKind::TransportClosed`]
//! or [`agent_tui_mcp::servers::McpClientEventKind::HandshakeFailed`] key for a
...
//!    [`agent_tui_mcp::servers::start_mcp_server`] sets
...
//!    push and stop.
//! 5. **Already-Empty** — see the [`agent_tui_mcp::servers::ClientStateKind::Empty`]
...
use agent_tui_mcp::servers::{McpClientEventKind, McpServerName};

...
mod permission_analytics_tests {
    ...
    use agent_tui_workspace::permission::{ClassifierSecurityFinding, reasons};
    ...
    fn prompt_outcome_covers_manager_vocabulary() {
        use agent_tui_workspace::permission::PromptOutcomeKind;
    ...
    fn classifier_source_enum_matches_manager_vocabulary() {
        use std::collections::BTreeSet;
        use agent_tui_workspace::permission::ClassifierSourceKind;
    ...
    fn classifier_verdict_enum_matches_manager_vocabulary() {
        use std::collections::BTreeSet;
        use agent_tui_workspace::permission::ClassifierVerdict;

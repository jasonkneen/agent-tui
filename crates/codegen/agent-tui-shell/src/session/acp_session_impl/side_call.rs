...
pub(crate) struct AuxCall {
    ...
    pub(crate) hosted_tools: Vec<agent_tui_sampling_types::HostedTool>,
    pub(crate) model: String,
    /// Must match the main turn's, or the prompt differs before the conversation history even starts.
    pub(crate) reasoning_effort: Option<agent_tui_sampling_types::ReasoningEffort>,
...
pub(crate) struct SideCallSetup {
    pub(crate) client: agent_tui_sampler::SamplingClient,

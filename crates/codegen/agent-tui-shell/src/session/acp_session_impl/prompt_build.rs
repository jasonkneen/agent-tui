...
impl SessionActor {
    ...
    async fn build_templated_user_message(
        ...
        use agent_tui_agent::prompt::agents_md::read_agents_config_with_paths;
        use agent_tui_agent::prompt::user_message::UserMessageContext;
    ...
    ) -> Vec<agent_tui_agent::prompt::user_message::McpServerEntry> {
        use agent_tui_agent::prompt::user_message::McpServerEntry;
    ...
    pub(super) async fn transcribe_user_images(
        ...
        let current_query = crate::session::image_describe::strip_template_context_tags(
            &agent_tui_chat_state::compaction_utils::extract_user_query(&original_user_message),
        );
        ...
        let client = agent_tui_sampler::SamplingClient::new(sampler_config).map_err(|e| {

...
pub(crate) enum SamplerFailureRecovery {
    ...
    RefreshAuthAndResubmit {
        credential: agent_tui_sampling_types::SentCredential,
...
pub(crate) enum SamplerTurnOutcome {
    ...
    Response(
        ...
        Box<agent_tui_sampler::InferenceLatencyStats>,
    ),
    CompactAndResubmit,
...
pub(crate) enum DrainSource {
    Pending(agent_tui_tools::implementations::grok_build::update_goal::UpdateGoalInput),
    Channel(agent_tui_tools::implementations::grok_build::update_goal::UpdateGoalEnvelope),
}

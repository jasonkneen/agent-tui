...
//!
//! The canonical types now live in `agent_tui_sampling_types::conversation`.
...
pub use agent_tui_sampling_types::conversation::*;
...
///
/// Stays in `agent-tui-shell` because it references
...
// via `Box::new(trace)`.
//
// Tests for conversation types now live in agent-tui-sampling-types crate.

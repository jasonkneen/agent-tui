...
impl SkillsFileWatcher {
    ...
    ///
    /// Uses [`collect_skill_config_dirs`](agent_tui_agent::prompt::skills::collect_skill_config_dirs)
    ...
    pub fn start(
        ...
        let dirs_to_watch = agent_tui_agent::prompt::skills::collect_skill_config_dirs(
            cwd,
            monorepo_user_dir,
            &grok_home,
            config_paths,

//! Todo types — re-exported from `agent-tui-tools` with ACP conversion helpers.
//!
//! Types are canonical in `agent-tui-tools`. This module adds ACP ↔ TodoItem
//! conversions since `agent-tui-tools` is protocol-agnostic.

pub use agent_tui_tools::implementations::grok_build::todo::TodoId;
pub use agent_tui_tools::implementations::grok_build::todo::TodoItem;
pub use agent_tui_tools::implementations::grok_build::todo::TodoPriority;
pub use agent_tui_tools::implementations::grok_build::todo::TodoState;
pub use agent_tui_tools::implementations::grok_build::todo::TodoStatus;

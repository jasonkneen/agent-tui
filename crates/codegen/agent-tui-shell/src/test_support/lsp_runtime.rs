...
pub(crate) fn ctx_with_toggle(toggle: HashMap<String, bool>) -> SubagentSpawnContext {
    ...
    SubagentSpawnContext {
        ...
        parent_skills: None,
        parent_skills_config: agent_tui_agent::prompt::skills::SkillsConfig::default(),
        parent_compat: agent_tui_tools::types::compat::CompatConfig::default(),
        task_completion_reservations: None,
        synthetic_trace_tx: None,
        task_output_tool_name: agent_tui_tools::reminders::task_completion::DEFAULT_TASK_OUTPUT_TOOL
            .to_string(),
...
impl agent_tui_tools::implementations::lsp::LspBackend for DummyLspDispatch {
    ...
    async fn dispatch(
        &self,
        _input: &agent_tui_tools::implementations::lsp::LspToolInput,
    ) -> agent_tui_tools::implementations::lsp::LspToolResult {
        agent_tui_tools::implementations::lsp::LspToolResult {
            text: String::new(),
            is_error: false,
        }
    ...
    ) -> Option<agent_tui_tools::implementations::lsp::DiagnosticsSummary> {
        None
    }
    ...
    ) -> Vec<agent_tui_tools::implementations::lsp::FileDiagnosticEntry> {
        vec![]
    }
}

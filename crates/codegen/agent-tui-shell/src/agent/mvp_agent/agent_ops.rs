...
use agent_tui_tools::implementations::grok_build::task::backend::SubagentBackend;
...
impl MvpAgent {
    ...
    pub(super) fn ensure_telemetry_client(&self) {
        ...
        if !mode.is_disabled() {
            ...
            agent_tui_telemetry::client::init_if_needed(
                cfg.telemetry.clone(),
                mode,
                user_id,
                team_id,
                ...
                agent_tui_version::VERSION.to_owned(),
                subscription_tier,
    ...
    pub(crate) fn plugin_registry_handle(
        &self,
    ) -> &agent_tui_agent::plugins::SharedPluginRegistryHandle {
    ...
    fn arm_local_workspace_watcher(
        ...
        let auth_path = agent_tui_workspace::hub_auth::default_auth_path().ok();
    ...
    fn ensure_local_workspace_ops(
        &self,
    ) -> Result<agent_tui_workspace::WorkspaceOps, acp::Error> {
        ...
        let workspace_identity = self
            ...
            .map(|a| match a.team_id.filter(|t| !t.is_empty()) {
                Some(team) => {
                    agent_tui_workspace::WorkspaceIdentity::team(a.user_id, team)
                }
                None => {
                    agent_tui_workspace::WorkspaceIdentity::new(
                        a.user_id,
                        a.principal_type,
                        a.principal_id,
                    )
            ...
            .unwrap_or_default();
        let ops = match agent_tui_workspace::handle::WorkspaceHandle::new_minimal(
            cwd.to_path_buf(),
            workspace_identity,
            project_lsp_trusted,
        ) {
            Ok(handle) => agent_tui_workspace::WorkspaceOps::local(handle),
            Err(e) => {
                tracing::error!(
                    error = %e,
    ...
    pub(super) async fn refresh_remote_settings(&self, auth: &crate::auth::GrokAuth) {
        ...
        agent_tui_telemetry::client::init(
            telemetry_config,
            telemetry_mode,
            grok_user_id,
            grok_team_id,
    ...
    pub(super) fn apply_polled_announcements(
        ...
        pre_fetch: Option<Vec<agent_tui_announcements::RemoteAnnouncement>>,
    ) {
        let mut cfg = self.cfg.borrow_mut();
    ...
    ///
    /// Both BYOK and session (OAuth) users go direct to `agent_tui_api_base_url`.
    ...
    pub(super) fn prepare_image_gen_config(
        &self,
    ) -> agent_tui_tools::implementations::grok_build::image_gen::ImageGenConfig {
        use agent_tui_tools::implementations::grok_build::image_gen::ImageGenConfig;
        ...
        let cfg = self.cfg.borrow();
        let base_url = cfg.endpoints.agent_tui_api_base_url.clone();
        let version = cfg
            .client_version
            .clone()
            .unwrap_or_else(|| agent_tui_version::VERSION.to_string());
        let alpha_test_key = cfg.endpoints.alpha_test_key.clone();
        let mut headers = indexmap::IndexMap::new();
        headers.insert("user-agent".to_string(), format!("agent-tui-build/{version}"));
    ...
    pub(super) fn prepare_app_builder_deployer_config(
        ...
        use agent_tui_tools::implementations::grok_build::deploy_app::AppBuilderDeployerConfig;
    ...
    pub(super) fn prepare_video_gen_config(
        &self,
    ) -> agent_tui_tools::implementations::grok_build::video_gen::VideoGenConfig {
        use agent_tui_tools::implementations::grok_build::video_gen::VideoGenConfig;
        let cfg = self.cfg.borrow();
    ...
    pub(super) fn prepare_web_fetch_config(
        &self,
    ) -> agent_tui_tools::implementations::grok_build::web_fetch::WebFetchConfig {
    ...
    pub fn with_models(
        ...
        let instance = Self {
            ...
            plugin_registry_handle: agent_tui_agent::plugins::SharedPluginRegistryHandle::new(
                None,
            ...
            monitor_event_buffer: agent_tui_tools::implementations::grok_build::monitor::types::MonitorEventBuffer::default(),
    ...
    pub(crate) async fn kill_background_task(
        ...
        session_id: &str,
        task_id: &str,
    ) -> Result<agent_tui_tools::types::KillOutcome, String> {
        let sid = acp::SessionId::new(session_id);
        if let Some(handle) = self.get_session_handle(&sid) {
    ...
    pub(crate) async fn cancel_subagent(
        &self,
        subagent_id: &str,
    ) -> agent_tui_tools::implementations::grok_build::task::types::SubagentCancelOutcome {
        agent_tui_tools::implementations::grok_build::task::backend::ChannelBackend::new(
    ...
    pub(crate) async fn list_running_subagents(
        ...
        agent_tui_tools::implementations::grok_build::task::types::SubagentInspection,
    > {
        agent_tui_tools::implementations::grok_build::task::backend::ChannelBackend::new(
                self.subagent_event_tx.clone(),
            )
    ...
    pub(crate) async fn query_subagent(
        ...
        agent_tui_tools::implementations::grok_build::task::types::SubagentSnapshot,
    > {
        agent_tui_tools::implementations::grok_build::task::backend::ChannelBackend::new(
                self.subagent_event_tx.clone(),
            )
    ...
    pub async fn list_tasks(
        &self,
        session_id: &str,
    ) -> Option<Vec<agent_tui_tools::types::TaskSnapshot>> {
        let sid = acp::SessionId::new(session_id);
        if let Some(handle) = self.get_session_handle(&sid) {
    ...
    pub(crate) async fn execute_hooks_action(
            ...
            && let Some(cwd) = self.get_session_cwd(session_id)
        {
            self.interactive_trust_prompted
                .borrow_mut()
                .remove(&agent_tui_workspace::trust::workspace_key(&cwd));
        }
        let handle = self.get_session_handle(session_id)?;
    ...
    pub(crate) fn plugin_registry_snapshot(
        &self,
    ) -> Option<std::sync::Arc<agent_tui_agent::plugins::PluginRegistry>> {
    ...
    pub(super) async fn build_harness_trace_uploads(
        ...
        for (offset, items) in turns.into_iter().enumerate() {
            ...
            let metadata = PromptMetadata {
                ...
                agent_type: None,
                shell_version: Some(agent_tui_version::VERSION.to_string()),
                workspace_type: None,
    ...
    pub(crate) async fn get_trace_context(
        ...
        let upload_method = match upload_method {
            Some(method) => method,
            None => {
                agent_tui_telemetry::session_ctx::log_session_event(crate::agent::session_metrics::TraceUploadSkipped {
        ...
        let queue = session_handle
            ...
            .get_or_init(|| {
                ...
                let queue = crate::upload::trace::spawn_upload_queue(
                    &grok_home,
                    &gcs_config,
                    Some(agent_tui_version::VERSION),
    ...
    /// [`agent_tui_agent::config::is_strict_harness_agent_type`].
    ///
    ...
    pub fn resolve_agent_definition(
        ...
        acp_agent_profile: Option<agent_tui_agent::AgentDefinition>,
        model_agent_type: Option<&str>,
    ) -> agent_tui_agent::AgentDefinition {
        ...
        let model_requires_strict_harness = model_agent_type
            .is_some_and(agent_tui_agent::config::is_strict_harness_agent_type);
        if !grok_agent_env_set && !config_agent_explicitly_set
            && model_requires_strict_harness && let Some(required) = model_agent_type
            && let Some(def) = agent_tui_agent::discovery::by_name_in_cwd(required, cwd)
        {
            tracing::info!(
                agent_name = %def.name,
        ...
        if let Some(ref name) = agent_config.name {
            ...
            if let Some(def) = agent_tui_agent::discovery::by_name_in_cwd(name, cwd) {
                return def;
            }
            tracing::warn!(
                agent_name = %name,
        ...
        let resolved = match agent_name.as_deref() {
            ...
            Some(name) => {
                agent_tui_agent::discovery::by_name_in_cwd(name, cwd)
            ...
            && resolved.name != required
        {
            ...
            if let Some(def) = agent_tui_agent::discovery::by_name_in_cwd(required, cwd) {
                return def;
            }
            tracing::warn!(
                model_agent_type = %required,
    ...
    pub(super) async fn spawn_and_register_session(
        ...
        let fs: Arc<dyn agent_tui_workspace::file_system::AsyncFileSystem> = if use_acp_fs {
        ...
        let mut session_env = agent_tui_workspace::permission::claude_settings::load_claude_env_with_project(
            cwd.as_path(),
            project_env_trusted,
        );
        let envrc = match preloaded_envrc {
            Some(env) => env,
            None => {
                agent_tui_workspace::envrc::load_envrc_or_empty_when_trusted(
                    cwd.as_path(),
        ...
        let pinned_model: Option<(acp::ModelId, ModelEntry)> = match &agent_definition
            .model
        {
            agent_tui_agent::config::ModelOverride::Override(id) => {
            ...
            agent_tui_agent::config::ModelOverride::Inherit => None,
        };
        ...
        if lsp_tools_enabled && tool_ctx.lsp.is_none() {
            ...
            let (
                ...
                .unzip();
            let sourced = agent_tui_tools::implementations::lsp::config::load_servers_with_plugins_sourced(
            ...
            if servers.is_empty() {
                let user_path = agent_tui_tools::util::grok_home::grok_home()
                    .join("lsp.json");
                ...
                use agent_tui_tools::implementations::lsp::{
                ...
                let mgr = std::sync::Arc::new(
                    tokio::sync::Mutex::new(
                        LspManager::new(
                                ...
                                true,
                                agent_tui_tools::notification::ToolNotificationHandle::noop(),
                            )
        ...
        let (mut handle, permission_events_rx, agent_system_prompt, session_thread) = {
            ...
            let attribution_callback: Option<
                agent_tui_sampler::SharedAttributionCallback,
            > = Some(
            ...
            let agent_hook_registry_override = agent_definition
                ...
                .and_then(|hooks_config| {
                    ...
                    let (specs, errors) = agent_tui_hooks::config::parse_hooks_from_value_with_dir(
                        &hooks_val,
                        &format!(
                        "{}{}",
                        agent_tui_hooks::config::AGENT_HOOK_PREFIX,
                    ...
                    let git_root = agent_tui_workspace::session::git::find_git_root_from_path(
                            cwd,
                        )
                        .ok();
            ...
            spawn_session_on_thread(
                    ...
                    subagent_toggle,
                    Vec::new(),
                    agent_tui_agent::prompt::context::PromptAudience::Primary,
                    None,
                    None,
                    disable_web_search,

...
use agent_tui_telemetry::events::ResourceReportTrigger;
...
impl MvpAgent {
    ...
    pub(super) fn report_resource_usage_if_due(&self) {
        let memory = agent_tui_tty_utils::sample_process_memory();

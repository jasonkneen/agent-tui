...
impl MvpAgent {
    ...
    pub(crate) fn remove_session(&self, id: &acp::SessionId) {
        let _ = self
            .subagent_event_tx
            .send(agent_tui_tools::implementations::grok_build::task::types::SubagentEvent::TeardownSession {
        ...
        self.log_resource_usage(agent_tui_telemetry::events::ResourceReportTrigger::SessionClose);
    }

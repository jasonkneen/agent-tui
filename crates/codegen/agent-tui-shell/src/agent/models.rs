...
use agent_tui_sampling_types::{ReasoningEffort, ReasoningEffortOption};
...
impl ModelsCacheManager {
    ...
    fn load_fresh(
        ...
        if cache.grok_version.as_deref() != Some(agent_tui_version::VERSION) {
    ...
    fn persist(
        ...
        let cache = ModelsCache {
            fetched_at: Utc::now(),
            grok_version: Some(agent_tui_version::VERSION.to_string()),
...
mod tests {
    ...
    fn reasoning_effort_override_skips_models_that_do_not_offer_level() {
        use indexmap::IndexMap;
        use agent_tui_sampling_types::ReasoningEffortOption;

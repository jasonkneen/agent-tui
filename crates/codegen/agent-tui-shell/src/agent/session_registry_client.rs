...
impl SessionRegistryClient {
    ...
    async fn send_authed(
        ...
        reqwest::Response,
        Option<agent_tui_auth::StampedBearerSuffix>,
    )> {
        ...
        agent_tui_auth::execute_with_stamp(&self.client, request)
            .await
            .map_err(|e| match e {
    ...
    /// [`agent_tui_auth::StampedBearerSuffix`] for why never a re-resolution).
    fn record_401_attribution(&self, op: &str, stamp: Option<&agent_tui_auth::StampedBearerSuffix>) {

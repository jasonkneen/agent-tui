...
impl PluginsConfig {
    ...
    pub fn to_discovery_config(&self) -> agent_tui_agent::plugins::discovery::DiscoveryConfig {
...
impl CliAgentOverrides {
    ...
    pub fn apply_to_definition(&self, def: &mut agent_tui_agent::config::AgentDefinition) {
    ...
    pub fn apply_to_subagent_definition(&self, def: &mut agent_tui_agent::config::AgentDefinition) {

...
fn canonical_total_tokens_does_not_double_count_reasoning() {
    let totals = agent_tui_chat_state::UsageTotals {
        input_tokens: 100,
        output_tokens: 40,
        reasoning_tokens: 25,
        ..Default::default()
...
async fn usage_ack_precedes_terminal_presentation() {
    ...
    let by_model = vec![(
            ...
            agent_tui_chat_state::UsageTotals {
                input_tokens: 10,
                output_tokens: 4,
                ..Default::default()
            },
...
fn inject_subagent_completed_prompt_sends_prompt_and_marks_delivered() {
    ...
    let reservations = agent_tui_tools::reminders::task_completion::TaskCompletionReservations::default();
...
fn explicit_override_takes_precedence_over_role() {
    ...
    assert_eq!(
            ...
            Some(agent_tui_tool_types::SubagentCapabilityMode::ReadOnly)
        );
}
#[test]
...
fn partial_override_fills_from_role() {
    ...
    assert_eq!(
            resolved.capability_mode,
            Some(agent_tui_tool_types::SubagentCapabilityMode::Execute)
        );
}
#[test]
...
fn forked_initial_context_inherits_parent_across_reasoning() {
    ...
    let items = vec![
            ...
            ConversationItem::Reasoning(agent_tui_sampling_types::synthesized_reasoning_item(
                "deliberating",
            )),

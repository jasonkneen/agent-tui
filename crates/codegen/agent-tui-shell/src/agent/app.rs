    ...
    W: tokio::io::AsyncWrite + Unpin + Send + 'static,
{
    ...
    let workspace_user_dir = agent_tui_agent::prompt::workspace_user::optional_workspace_user_dir();
        ...
        .run_until(async move {
            let _agent_handle = tokio::task::spawn_local(async move {
                ...
                tokio::task::spawn_local(
                    GatewayReceiver::new(gw_rx, conn)
                        .with_on_meta(
                            agent_tui_file_utils::trace_context::span_from_meta_traceparent,
                        )
                        .run(),
                );
...
pub async fn run_leader(
    ...
    local_set
        .run_until(async move {
            ...
            let initial_auth_key_hash = agent_tui_config::user_grok_home()

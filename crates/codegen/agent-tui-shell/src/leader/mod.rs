...
//!
//! ```ignore
//! use agent_tui_shell::leader::{connect_or_spawn, ClientCapabilities, ClientMode};
//!
...
const CLIENT_LEADER_VERSION: &str = agent_tui_version::VERSION;
                ...
                Ok(()) => {
                    ...
                    crate::unified_log::warn(
                        ...
                        Some(serde_json::json!({
                            ...
                            "reason": reason,
                            "killer_ver": agent_tui_version::VERSION,
                        })),
                    );
                }
                Err(e) => {
...
pub async fn connect_or_spawn(
    ...
    if let Some(profile) = agent_tui_sandbox::requested_confinement_profile() {
...
/// `agent_tui_update::auto_update::resolve_restart_exe`.
///

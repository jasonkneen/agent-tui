...
//!
//! ```text
//! cargo bench -p agent-tui-shell --bench skills_watcher_startup
//! # optional scale:
//! GROK_SKILLS_WATCHER_BENCH_DIRS=12000 cargo bench -p agent-tui-shell --bench skills_watcher_startup
//! ```
//!
...
use agent_tui_shell::config::watcher::SkillsFileWatcher;

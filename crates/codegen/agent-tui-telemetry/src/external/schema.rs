...
/// Built-in tool names (closed enum surface in `agent-tui-tools`) that pass
...
fn tool_outcome_label(o: &agent_tui_file_utils::events::types::ToolOutcome) -> &'static str {
    use agent_tui_file_utils::events::types::ToolOutcome;
    match o {

...
fn external_stream_end_to_end() {
    ...
    let mut cfg = agent_tui_telemetry::external::ExternalOtelConfig::resolve_with(
        |name| match name {
    ...
    cfg.client = agent_tui_telemetry::external::config::ExternalClientInfo {
        service_version: "0.0.0-test".into(),
        client_version: "0.0.0-test".into(),
        app_entrypoint: "cli".into(),
    };

    agent_tui_telemetry::external::init(Some(cfg));
    assert!(agent_tui_telemetry::external::is_active());
    ...
    assert!(!agent_tui_telemetry::is_enabled());
    agent_tui_telemetry::log_event(agent_tui_telemetry::events::SessionNew {
        session_id: "sess-int-1".into(),
        client_identifier: None,
        client_version: None,
        is_git_repo: true,
        permission_mode: agent_tui_telemetry::enums::PermissionMode::Ask,
    });
    agent_tui_telemetry::log_event(agent_tui_telemetry::events::SessionHarness {
        session_id: "sess-int-1".into(),
    ...
    agent_tui_telemetry::log_event(agent_tui_telemetry::events::PromptSubmitted {
    ...
    agent_tui_telemetry::log_event(agent_tui_telemetry::events::ModelResponseReceived {
    ...
    agent_tui_telemetry::external::flush();
    ...
    agent_tui_telemetry::external::shutdown();
    assert!(

//! Integration tests for agent-tui-hooks.
//!
...
use agent_tui_hooks::discovery::load_hooks;
use agent_tui_hooks::dispatcher;
use agent_tui_hooks::event::*;
use agent_tui_hooks::result::HookDecision;
use agent_tui_hooks::runner::RunContext;
    ...
    let cases = vec![
        ...
        Case {
            ...
            payload: HookPayload::StopFailure {
                error: agent_tui_hooks::event::StopFailureKind::RateLimit,

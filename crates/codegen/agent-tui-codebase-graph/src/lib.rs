...
//! ```rust,ignore
//! use std::path::Path;
//! use agent_tui_codebase_graph::{IndexBuilder, load_index, save_index, get_cache_path, Navigator};
//!
...
//! use agent_tui_codebase_graph::{IndexManager, IndexManagerConfig, FileEvent};
//!

//! Criterion benchmarks for the agent-tui-pager rendering pipeline.
//!
...
use agent_tui_pager::scrollback::render::render_scrolled_entries_with_scratch;
use agent_tui_pager::scrollback::wrappers::EntryRenderer;
use agent_tui_pager::scrollback::{

...
//!
//! ```text
//! cargo bench -p agent-tui-pager --bench edit_highlight
//! cargo bench -p agent-tui-pager --bench edit_highlight -- edit_hl/upgrade
//! ```
...
use agent_tui_pager::diff::{DiffHunk, DiffLine};
use agent_tui_pager::scrollback::blocks::tool::{
...
use agent_tui_pager::syntax::{Syntect, get_syntect};

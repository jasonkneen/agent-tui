# Agent TUI User Guide

Learn how to install, configure, and extend **Agent TUI**, a packaging fork of Grok Build. Grok / xAI remain the model providers (including Composer models). See the repo root [FORK.md](../../../../../FORK.md).
...
Customize and extend Agent TUI.
...
Automate, script, and integrate Agent TUI with other systems.

| # | Document | Description |
|---|----------|-------------|
| 14 | [Headless Mode and Scripting](14-headless-mode.md) | `agent-tui -p`, output formats, CI/CD integration, and piping |

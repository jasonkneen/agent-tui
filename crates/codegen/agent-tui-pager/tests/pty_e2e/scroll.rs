...
use agent_tui_pager_pty_harness::PtyHarness;
pub(crate) use agent_tui_pager_pty_harness::{SGR_SCROLL_DOWN, SGR_SCROLL_UP};
...
/// (`agent-tui-pager-pty-harness/src/scroll_matrix/runner.rs`) ports this
...
/// `agent-tui-pager-pty-harness/src/scroll_matrix/session.rs` is a port of

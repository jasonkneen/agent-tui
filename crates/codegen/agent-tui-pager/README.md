...
- [Hook Examples](../agent-tui-hooks/examples/README.md) — sample hooks for common workflows
- [Hooks Crate (`agent-tui-hooks`)](../agent-tui-hooks/) — hook runtime, event types, and execution engine
- [Plugin Marketplace Crate (`agent-tui-plugin-marketplace`)](../agent-tui-plugin-marketplace/) — marketplace source loading, scanning, and install

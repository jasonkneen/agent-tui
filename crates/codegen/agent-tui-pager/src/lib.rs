//! agent-tui-pager — Grok Build TUI.
//!
...
// minimal rendering lives in the sibling `agent-tui-pager-minimal` crate; these
...
// `agent-tui-pager-render`. Re-exported at the crate root so existing
// `crate::<module>::...` references throughout the pager keep resolving.
pub use agent_tui_pager_render::{

...
use agent_tui_config::managed_text::{
...
pub enum FixError {
    ...
    Managed(agent_tui_config::managed_text::ManagedConfigError),
    TmuxManaged(agent_tui_config::managed_text::ManagedConfigError),
    PostconditionFailed,
...
impl From<agent_tui_config::managed_text::ManagedConfigError> for FixError {
    fn from(error: agent_tui_config::managed_text::ManagedConfigError) -> Self {
        Self::Managed(error)
    }
}

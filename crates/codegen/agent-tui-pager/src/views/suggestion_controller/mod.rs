...
// (e.g. agent-tui-pager-minimal's) compiling when optional fields are added.
#[derive(Debug, Clone, Default)]
...
impl SuggestionController {
    pub fn new() -> Self {
        Self {
            ...
            tab_pending: None,
            enabled: agent_tui_config::env_bool("GROK_SUGGESTIONS").unwrap_or(false),
            dropdown: CompletionDropdownState::default(),
            ai_enabled: agent_tui_config::env_bool("GROK_SUGGESTIONS_AI").unwrap_or(false),

...
pub enum LocalQuestionKind {
    ...
    CreditLimitUpsell {
        choices: Vec<agent_tui_telemetry::events::CreditLimitChoice>,
    },
    ...
    FreeUsageUpsell {
        ...
        source: agent_tui_telemetry::events::SuperGrokUpsell,
    },
...
impl QuestionViewState {
    ...
    pub fn build_accepted_response(
        &self,
    ) -> agent_tui_tools::implementations::grok_build::ask_user_question::AskUserQuestionExtResponse
    {
    ...
    pub fn send_ext_response(
        &mut self,
        response: agent_tui_tools::implementations::grok_build::ask_user_question::AskUserQuestionExtResponse,
    ) -> bool {

...
impl MemoryModalState {
    ...
    #[cfg(test)]
    fn query_viewport(&self, width: usize) -> agent_tui_ratatui_textarea::SingleLineViewport {
...
pub fn build_entries(
    files: Vec<agent_tui_shell::extensions::notification::MemoryFileInfo>,
) -> Vec<MemoryFileEntry> {
...
mod tests {
    ...
    fn build_entries_groups_by_source() {
        use agent_tui_shell::extensions::notification::MemoryFileInfo;

...
pub struct NotificationMeta {
    ...
    /// (`"{sessionId}-{counter}"`, see `agent-tui-shell util::event_id`). The
...
/// replayed notifications (`_meta.isReplay`, stamped by agent-tui-shell's
...
pub mod user_message_chunk_meta {
    ...
    /// ([`agent_tui_shell::session::PromptOrigin::hide_user_echo_from_scrollback`]).

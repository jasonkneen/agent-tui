...
pub async fn run_single_turn(
    ...
    let report_startup_failure = |timer: &crate::acp::StartupTimer| {
        ...
        agent_tui_telemetry::startup::report_total(crate::acp::StartupOutcome::Error);
    };
    ...
    agent_tui_telemetry::startup::enter(crate::acp::StartupPhase::AcpInitialize);
    ...
    agent_tui_telemetry::startup::enter(crate::acp::StartupPhase::EagerAuth);
    ...
    agent_tui_telemetry::startup::enter(crate::acp::StartupPhase::SessionCreate);
    ...
    agent_tui_telemetry::startup::report_total(crate::acp::StartupOutcome::Ok);
    tracing::debug!(
    ...
    let outcome: Result<()> = match prompt_result {
        ...
        Some(Err(err)) => {
            ...
            let stop_reason_override =
                (agent_tui_shell::sampling::error::stop_reason_for_turn_error(&err) == "MaxTokens")

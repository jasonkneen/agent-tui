...
/// Emit [`agent_tui_telemetry::events::ShortcutUsed`] for an allowlisted binding.
///
...
pub fn log_shortcut_used(key: &KeyEvent, action_id: ActionId, context: &str) {
    ...
    agent_tui_telemetry::session_ctx::log_event(agent_tui_telemetry::events::ShortcutUsed {

...
//!
//! ```text
//! cargo run -p agent-tui-pager --bin todo-pane-playground
//! ```
//!
...
use agent_tui_pager::views::todo_pane::TodoPane;
use agent_tui_shell::tools::{TodoItem, TodoPriority, TodoStatus};

...
pub(super) fn push_server_status_enabled() -> bool {
    ...
    *ENABLED.get_or_init(|| {
        agent_tui_shell::util::config::resolve_mcp_push_server_status(
...
/// `agent-tui-shell/src/session/acp_session.rs` — toggle-tool ~L6661,
...
///    [`agent_tui_shell::extensions::mcp::McpToolsChanged`] struct), and
...
/// ([`agent_tui_shell::extensions::mcp::McpServerStatusPayload`] +
/// [`agent_tui_shell::extensions::mcp::McpServerStatus`]) instead of
...
pub(super) fn handle_mcp_server_status(notif: &acp::ExtNotification, app: &mut AppView) -> bool {
    ...
    use agent_tui_shell::extensions::mcp::{McpServerStatus, McpServerStatusPayload, McpToolEntry};
...
/// on config reload (`crates/codegen/agent-tui-shell/src/agent/mvp_agent.rs`

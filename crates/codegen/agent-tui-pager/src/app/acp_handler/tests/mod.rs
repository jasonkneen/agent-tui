...
use agent_tui_shell::extensions::notification::RetryState;
use agent_tui_shell::extensions::notification::SessionUpdate as XaiSessionUpdate;
...
pub(super) fn compressed_entry(
    index: usize,
) -> agent_tui_shell::extensions::notification::ImageCompressedEntry {
    agent_tui_shell::extensions::notification::ImageCompressedEntry {
        index,
...
pub(super) fn agent_tui_model_switch_notif(
    session_id: &str,
    event_id: &str,
) -> acp::ExtNotification {
...
pub(super) fn agent_tui_unhandled_notif(
    session_id: &str,
    event_id: &str,
) -> acp::ExtNotification {
    let payload = SessionNotification {
...
pub(super) fn agent_tui_turn_completed_notif(
    session_id: &str,
    prompt_id: &str,
    stop_reason: &str,
    is_replay: bool,
...
pub(super) fn agent_tui_turn_completed_notif_with_cancel_trigger(
    session_id: &str,
    prompt_id: &str,
    stop_reason: &str,
    cancel_trigger: &str,
...
pub(super) fn agent_tui_wake_turn_completed_notif(
    session_id: &str,
    prompt_id: &str,
...
pub(super) fn agent_tui_hook_execution_notif_for_prompt(
    session_id: &str,
    event_name: &str,
...
pub(super) fn agent_tui_hook_execution_notif_with_runs(
    session_id: &str,
    event_name: &str,
    prompt_id: Option<&str>,
    is_replay: bool,
    runs: Vec<agent_tui_shell::extensions::notification::HookRunEntryDto>,
) -> acp::ExtNotification {
    let payload = SessionNotification {
        session_id: acp::SessionId::new(session_id),
...
pub(super) fn agent_tui_hook_execution_notif(
    session_id: &str,
    event_name: &str,
    is_replay: bool,
) -> acp::ExtNotification {
    agent_tui_hook_execution_notif_for_prompt(session_id, event_name, None, is_replay)
}
...
pub(super) fn make_git_head_changed_notif(
    ...
    let payload = agent_tui_workspace::session::git::GitHeadChanged {
...
pub(super) fn make_server_status_notif(
    session_id: &str,
    name: &str,
    status: agent_tui_shell::extensions::mcp::McpServerStatus,
    tools: Option<serde_json::Value>,
) -> acp::ExtNotification {
    use agent_tui_shell::extensions::mcp::{
...
pub(super) fn make_tools_changed_notif_post_h2(
    ...
    let payload = agent_tui_shell::extensions::mcp::McpToolsChanged {
        session_id: session_id.to_string(),

...
fn open_extensions_modal_no_session_sets_flag_no_fetches() {
    ...
    let effects = dispatch(
        Action::OpenExtensionsModal {
            ...
            trigger: agent_tui_telemetry::events::ExtensionsModalTrigger::SlashCommand,
        },
        &mut app,
    );
...
fn success_outcome() -> agent_tui_hooks_plugins_types::ActionOutcome {
...
fn empty_marketplace_response() -> agent_tui_hooks_plugins_types::MarketplaceListResponse {
    agent_tui_hooks_plugins_types::MarketplaceListResponse { sources: vec![] }
}

    ...
    let response = agent_tui_hooks_plugins_types::MarketplaceListResponse {
        sources: vec![
            ...
            agent_tui_hooks_plugins_types::MarketplaceScanResult {
                ...
                source_kind: "git".into(),
                source_url_or_path: "git@github.com:agent-tui-org/plugin-marketplace.git".into(),
...
mod cta_e2e {
    ...
    fn dismissed_plugin_suppressed_on_next_recompute() {
        ...
        let dismissed = agent_tui_shell::config::dismissed_plugin_ctas_in_file(&config_path);
        let matched =
        ...
        agent_tui_shell::config::add_dismissed_plugin_cta_to_file("figma", &config_path)

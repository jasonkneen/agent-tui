...
fn critical_announcement(id: &str) -> agent_tui_announcements::RemoteAnnouncement {
...
fn promo_announcement(id: &str) -> agent_tui_announcements::RemoteAnnouncement {
    agent_tui_announcements::RemoteAnnouncement {
        id: Some(id.into()),
        message: Some(format!("{id} message")),
        severity: Some("promo".into()),
        cta: Some(agent_tui_announcements::AnnouncementCta {
            label: Some("Go".into()),
    ...
    assert!(
        matches!(
            ...
            [Effect::RenameSession { kind, .. }]
                if *kind == agent_tui_shell::session::unified_list::SessionKind::Chat
        ),
    ...
    assert!(
        matches!(
            ...
            [Effect::RenameSession { kind, title, .. }]
                if *kind == agent_tui_shell::session::unified_list::SessionKind::Build
                    && title == "local title"
        ),

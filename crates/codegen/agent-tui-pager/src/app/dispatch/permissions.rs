...
///
/// Special case for [`agent_tui_workspace::permission::ENABLE_ALWAYS_APPROVE_OPTION_ID`]:
...
pub(super) fn dispatch_permission_select(
    ...
    let steers_next_cursor = !enable_always_approve
        && option_id.0.as_ref() != agent_tui_workspace::permission::ALLOW_EDITS_SESSION_OPTION_ID;

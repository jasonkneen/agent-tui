...
pub(crate) async fn run(
    ...
    if let Some(action) = startup_action {
        ...
        agent_tui_telemetry::startup::report_total(agent_tui_telemetry::startup::StartupOutcome::Ok);
    }
    ...
    if let Some(initial_prompt) = args.initial_prompt() {
        if !app.session_startup_allowed() {
            ...
            agent_tui_telemetry::startup::report_total(
                agent_tui_telemetry::startup::StartupOutcome::Ok,
            );
        }
    }

...
/// [`agent_tui_shell::util::config::resolve_hints`]; this type is the pager's
/// in-memory mirror.
...
impl From<agent_tui_shell::util::config::WorktreeHintMode> for WorktreeMode {
    fn from(mode: agent_tui_shell::util::config::WorktreeHintMode) -> Self {
        use agent_tui_shell::util::config::WorktreeHintMode;
        match mode {
...
impl WorktreeMode {
    ...
    pub fn from_config_str(s: &str) -> Self {
        agent_tui_shell::util::config::WorktreeHintMode::from_config_str(s).into()
    }
    ...
    pub fn resolve_from_hints_value(hints: Option<&toml::Value>) -> (Self, Self) {
        let (new_session, fork) =
            agent_tui_shell::util::config::WorktreeHintMode::resolve_pair(hints);
...
/// [`agent_tui_workspace::folder_trust::decide`] verdict; when the feature flag
...
/// (toolset) gate via [`agent_tui_shell::tier::is_restricted_tier_name`] so
...
fn is_restricted_tier(tier: Option<&str>) -> bool {
    match tier {
        None => true,
        Some(t) => agent_tui_shell::tier::is_restricted_tier_name(t),
    }
}
...
pub struct AppView {
    ...
    /// stays sans-IO.
    pub current_ui: agent_tui_shell::agent::config::UiConfig,
    /// Working directory.
    pub cwd: PathBuf,
    ...
    pub active_announcements: Vec<agent_tui_announcements::RemoteAnnouncement>,
    ...
    pub announcement: Option<agent_tui_announcements::RemoteAnnouncement>,
    ...
    /// empty and inert outside `--minimal`; the `agent-tui-pager-minimal` crate
    ...
    /// `agent_tui_shell::util::config::resolve_auto_permission_mode_enabled`.
    ...
    pub contextual_hints: agent_tui_shell::util::config::ResolvedContextualHints,
    ...
    pub remote_contextual_hints: Option<agent_tui_shell::util::config::ContextualHintsRemote>,
    ...
    pub announcement_cta_impressions_logged:
        std::collections::BTreeSet<(String, agent_tui_telemetry::events::AnnouncementCtaSurface)>,
    /// Access gate from `grok_build_access_gate`. `Some` = blocked.
    pub gate: Option<agent_tui_shell::auth::GateInfo>,
    ...
    pub pending_gate_verification: Option<agent_tui_shell::auth::GateInfo>,
...
impl AppView {
    ...
    pub fn gate_from_settings(
        rs: &agent_tui_shell::util::config::RemoteSettings,
    ) -> Option<agent_tui_shell::auth::GateInfo> {
        let msg = rs.gate_message.as_ref()?;
        if msg.is_empty() {
            return None;
        }
        Some(agent_tui_shell::auth::GateInfo {
            message: msg.clone(),
    ...
    pub fn apply_auth_meta(&mut self, meta: &agent_tui_shell::auth::AuthMeta) {
        ...
        if was_gated && self.gate.is_none() {
            ...
            agent_tui_telemetry::session_ctx::log_event(
                agent_tui_telemetry::events::SubscriptionActivated {
    ...
    pub fn new(
        ...
        Self {
            ...
            current_ui: agent_tui_shell::agent::config::UiConfig::default(),
            ...
            voice_config: agent_tui_voice::VoiceConfig::default(),
            voice_auth: None,
            voice_cmd_tx: None,
    ...
    fn voice_send(&self, cmd: agent_tui_voice::VoiceCommand) {
    ...
    pub(crate) fn voice_begin_recording(&mut self, target: VoiceTarget, hold: bool) {
        self.voice_send(agent_tui_voice::VoiceCommand::PttPress);
    ...
    pub(crate) fn voice_stop_keeping_final(&mut self) {
        ...
        self.voice_send(agent_tui_voice::VoiceCommand::PttRelease);
        ...
        if matches!(ctx.auth_state, AuthState::Done) {
            if ctx.upgrade_cta_keyboard && key!('o', CONTROL).matches(key) {
                return InputOutcome::Action(Action::AnnouncementsOpenCta(
                    agent_tui_telemetry::events::AnnouncementCtaSurface::Keyboard,
                ));
            }
    ...
    if let Event::Mouse(mouse) = ev {
        ...
        match mouse.kind {
            MouseEventKind::Down(MouseButton::Left) => {
                ...
                {
                    return InputOutcome::Action(Action::AnnouncementsOpenCta(
                        agent_tui_telemetry::events::AnnouncementCtaSurface::Welcome,
                    ));
                }
...
impl AppView {
                ...
                match *active_view {
                    ActiveView::Welcome => {
                        ...
                        if !has_access && !self.access_gate_shown_logged {
                            ...
                            agent_tui_telemetry::session_ctx::log_event(
                                agent_tui_telemetry::events::SuperGrokUpsellShown {
                                    source:
                                        agent_tui_telemetry::events::SuperGrokUpsell::WelcomeScreen,
                                    auth_method: self
                                        .login_method_id
                                        .as_ref()
    ...
    /// Log [`agent_tui_telemetry::events::AnnouncementCtaShown`] for each
    ...
    pub(crate) fn log_announcement_cta_impressions(&mut self) {
        use agent_tui_telemetry::events::AnnouncementCtaSurface;
        ...
        let key = agent_tui_announcements::announcement_hide_key(owner);
        ...
        for (surface, _) in surfaces.into_iter().filter(|(_, painted)| *painted) {
            ...
            {
                agent_tui_telemetry::session_ctx::log_event(
                    agent_tui_telemetry::events::AnnouncementCtaShown {
                        id: id.clone(),
                        source: surface,
                    },
                );
...
impl AppView {
    ...
    pub fn apply_contextual_hints(
        &mut self,
        resolved: agent_tui_shell::util::config::ResolvedContextualHints,
    ) {
    ...
    fn apply_clipboard_probe(
        ...
        if agent.show_ephemeral_tip(
            ...
            agent_tui_telemetry::session_ctx::log_event(agent_tui_telemetry::events::ContextualTip {
                tip: agent_tui_telemetry::events::ContextualTipKind::ImageInput,
                action: agent_tui_telemetry::events::ContextualTipAction::Shown,
            });
            return true;
        }
        false
...
pub(crate) mod tests {
    ...
    fn slash_gate_resyncs_when_critical_expires_between_pushes() {
        ...
        app.active_announcements = vec![agent_tui_announcements::RemoteAnnouncement {
    ...
    fn needs_animation_gates_todo_badge_flash() {
        ...
        app.agents
            ...
            .unwrap()
            .todo
            .update_todos(vec![agent_tui_shell::tools::TodoItem {
                content: "do the thing".into(),
                priority: Default::default(),
                status: agent_tui_shell::tools::TodoStatus::InProgress,
                meta: None,
            }]);
        assert!(
    ...
    fn external_auth_provider_keeps_billing_off_after_auth_meta() {
        ...
        app.apply_auth_meta(&agent_tui_shell::auth::AuthMeta::default());
    ...
    fn apply_auth_meta_disables_billing_surface_for_team_users() {
        let mut app = test_app();
        assert!(app.usage_visible);
        let meta = agent_tui_shell::auth::AuthMeta {
    ...
    fn apply_auth_meta_enables_billing_surface_for_personal_users() {
        let mut app = test_app();
        app.usage_visible = false;
        let meta = agent_tui_shell::auth::AuthMeta::default();
        app.apply_auth_meta(&meta);
        assert!(app.usage_visible);
    }
    #[test]
    ...
    fn apply_auth_meta_api_key_enables_voice_and_skips_tier_gate() {
        ...
        app.apply_auth_meta(&agent_tui_shell::auth::AuthMeta {
    ...
    fn apply_auth_meta_clears_gate_on_subscription() {
        let mut app = test_app();
        app.gate = Some(agent_tui_shell::auth::GateInfo {
    ...
    fn apply_auth_meta_gate_unchanged_when_still_gated() {
        let mut app = test_app();
        let gate = agent_tui_shell::auth::GateInfo {
    ...
    fn welcome_ctrl_u_update_keeps_priority_over_foreign_resume() {
        ...
        app.apply_foreign_resume_detection(
            launch_token,
            &canonical_cwd,
            Some(agent_tui_workspace::foreign_sessions::RecentForeignSession {
                tool: agent_tui_workspace::foreign_sessions::ForeignSessionTool::Cursor,
    ...
    fn esc_owned_before_agent_covers_app_level_owners() {
        ...
        app.import_claude_modal = Some(
            crate::views::import_claude_modal::ImportClaudeModalState::new(
                agent_tui_shell::claude_import::ImportPlan::default(),
    ...
    fn overlay_left_arrow_file_search_open_does_not_exit() {
        let (mut app, id) = neutral_overlay_app();
        {
            ...
            agent.prompt.file_search.set_test_state(
                ctx,
                vec![agent_tui_workspace::file_system::FuzzyMatchResult {

...
/// `agent-tui-shell/src/agent/handlers/session.rs::handle_roster_list`), which
...
mod tests {
    ...
    fn agent_entry() -> agent_tui_shell::agent::roster::RosterEntry {
        use agent_tui_shell::agent::roster as agent;
        agent::RosterEntry {

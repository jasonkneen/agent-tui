...
impl AgentView {
    ...
    fn log_extensions_modal_action(
        &self,
        action: &str,
        input_method: agent_tui_telemetry::events::ExtensionsInputMethod,
    ) {
    ...
    fn log_extensions_modal_action_with(
        ...
        if let Some(ref state) = self.extensions_modal {
            agent_tui_telemetry::session_ctx::log_event(
                agent_tui_telemetry::events::ExtensionsModalAction {
    ...
    pub(super) fn handle_extensions_modal_key(
            ...
            })
        {
            self.log_extensions_modal_action(
                "open_connectors",
                agent_tui_telemetry::events::ExtensionsInputMethod::Keyboard,
            );
        ...
        if let Some(ch) = chrome_shortcut_ch {
                ...
                .and_then(|s| crate::views::extensions_modal::resolve_key(s.active_tab, ch))
            {
                self.log_extensions_modal_resolved_action(
                    ch,
                    &action,
                    agent_tui_telemetry::events::ExtensionsInputMethod::Mouse,
                );
                    ...
                    && let Some(plugin) = data.plugins.get(idx)
                {
                    ...
                    return self.prompt_extensions_confirm(
                        ...
                        crate::views::extensions_modal::ConfirmationAction::Plugins(
                            agent_tui_hooks_plugins_types::PluginsAction::Uninstall {
                                plugin_id,
...
mod extensions_action_target_tests {
    ...
    fn skills_toggle_resolves_name_and_resulting_state() {
        let skill = agent_tui_tools::implementations::skills::types::SkillInfo {
            name: "my-skill".into(),
            enabled: false,
            ..Default::default()
        };
...
mod extensions_modal_confirmation_tests {
    ...
    fn plugin_info(name: &str) -> agent_tui_hooks_plugins_types::PluginInfo {
        agent_tui_hooks_plugins_types::PluginInfo {
            name: name.into(),
            id: format!("user/abcd1234/{name}"),
            root: "/tmp/p".into(),
    ...
    fn hook_info(name: &str, source_dir: &str) -> agent_tui_hooks_plugins_types::HookInfo {
        agent_tui_hooks_plugins_types::HookInfo {
            name: name.into(),
            event: agent_tui_hooks_plugins_types::HookEvent::PreToolUse,
            handler_type: agent_tui_hooks_plugins_types::HookHandlerType::Command,
    ...
    fn marketplace_loaded() -> TabDataState<agent_tui_hooks_plugins_types::MarketplaceListResponse> {
        TabDataState::Loaded(agent_tui_hooks_plugins_types::MarketplaceListResponse {
            sources: vec![agent_tui_hooks_plugins_types::MarketplaceScanResult {
                source_name: "test-source".into(),
                source_kind: "git".into(),
    ...
    fn all_prompt_cases() -> Vec<PromptCase> {
        ...
        plugins.plugins_data = TabDataState::Loaded(agent_tui_hooks_plugins_types::PluginsListResponse {
        ...
        hooks.hooks_data = TabDataState::Loaded(agent_tui_hooks_plugins_types::HooksListResponse {
        ...
        vec![
            ...
            PromptCase {
                ...
                expected: ConfirmationAction::Hooks(agent_tui_hooks_plugins_types::HooksAction::Remove {
                    path: source.into(),
                }),
                row: 0,
            },
    ...
    fn plugin_y_sends_confirmed_false_so_server_can_gate_multi() {
        ...
        assert_eq!(
            ...
            Some(agent_tui_hooks_plugins_types::PluginsAction::Uninstall {
                plugin_id: "user/abcd1234/my-plugin".into(),
                confirmed: false,
            })
        );

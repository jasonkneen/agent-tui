...
impl AgentView {
    ...
    pub fn draw(
        ...
        if let Some(profile) = agent_tui_sandbox::profile_name() {
        ...
        self.pane_areas = layout.pane_areas();
        {
            ...
            if route.emit_osc8 {
                ...
                *link_spans_out = self
                    ...
                    .map(|link| agent_tui_ratatui_inline::LinkSpan {
                        row: link.screen_row,
    ...
    fn ctrl_f_hint_follows_the_key_in_every_focus_mode() {
        ...
        perm.options = vec![acp::PermissionOption::new(
            acp::PermissionOptionId::new(Arc::from(
                agent_tui_workspace::permission::ALLOW_EDITS_SESSION_OPTION_ID,
            )),

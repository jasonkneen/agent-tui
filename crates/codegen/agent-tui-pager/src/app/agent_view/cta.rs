...
impl AgentView {
    ...
    pub(crate) fn log_prompt_suggestion_shown_if_visible(&mut self) {
        ...
        agent_tui_telemetry::session_ctx::log_event(agent_tui_telemetry::events::PromptSuggestion {
            action: agent_tui_telemetry::events::PromptSuggestionAction::Shown,
            chars,
            words,
        });
    }
    ...
    pub(in crate::app) fn connect_matched_plugin(&mut self) {
        ...
        agent_tui_telemetry::session_ctx::log_event(
            agent_tui_telemetry::events::PluginCtaConnectClicked {
        ...
        self.pending_effects
            .push(super::actions::Effect::InstallPluginFromCta {
                agent_id: self.session.id,
                session_id,
                source_url_or_path: agent_tui_plugin_marketplace::OFFICIAL_SOURCE_GIT_URL
                    .to_string(),
                plugin_relative_path,
            });
    }
...
mod prompt_suggestion_gate_tests {
    ...
    fn an_open_question_card_closes_the_suggestion_gate() {
        ...
        use agent_tui_tools::implementations::grok_build::ask_user_question::Question;

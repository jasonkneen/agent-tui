...
impl AgentView {
    ...
    pub(super) fn submit_question_answers(&mut self, skipped: bool) -> InputOutcome {
        ...
        agent_tui_telemetry::session_ctx::log_event(agent_tui_telemetry::events::PlanSubmit {
...
mod permission_scope_key_tests {
    ...
    fn setup_bash_permission(agent: &mut AgentView) {
        ...
        perm.bash_highlights = Some(
            agent_tui_workspace::permission::bash_command_splitting::BashCommandHighlights {
                prefix: vec![],

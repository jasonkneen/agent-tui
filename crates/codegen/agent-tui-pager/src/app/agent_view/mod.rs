...
pub struct AgentView {
    ...
    pub context_state: Option<agent_tui_shell::session::ContextInfo>,
    ...
    pub(crate) deferred_session_mode: Option<agent_tui_tools::types::SessionMode>,
    ...
    match kind {
        ...
        LocalQuestionKind::CreditLimitUpsell { choices } => {
            ...
            let choice = choices
                .get(*idx)
                .copied()
                .unwrap_or(agent_tui_telemetry::events::CreditLimitChoice::PayAsYouGo);
            agent_tui_telemetry::session_ctx::log_event(
                agent_tui_telemetry::events::CreditLimitUpsellClicked {
        ...
        LocalQuestionKind::FreeUsageUpsell { source } => {
            ...
            agent_tui_telemetry::session_ctx::log_event(
                agent_tui_telemetry::events::SuperGrokUpsellClicked {
                    source,
                    auth_method: None,
                },
            );
...
fn translate_project_select(
    ...
    use agent_tui_telemetry::events::{ProjectPickerOutcome, ProjectPickerSelected};
    let project_dir_options = resolved_paths.len().saturating_sub(1);
    let emit = |outcome: ProjectPickerOutcome| {
        agent_tui_telemetry::session_ctx::log_event(ProjectPickerSelected {
            outcome,
...
fn remember_mode_enabled() -> bool {
    let path = agent_tui_tools::util::grok_home::grok_home().join("config.toml");
...
fn question_visible_h(
    ...
    prompt_height: u16,
    question: &agent_tui_tools::implementations::grok_build::ask_user_question::Question,
    content_w: usize,
    preview: Option<&str>,
    fullscreen: bool,
    desc_cap: u16,

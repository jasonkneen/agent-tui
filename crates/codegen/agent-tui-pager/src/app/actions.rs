...
use agent_tui_shell::session::unified_list::SessionKind;
...
pub enum SwitchModelError {
    ...
    /// `acp::Error.data`.
    IncompatibleAgent {
        error: agent_tui_shell::agent::config::ModelSwitchIncompatibleAgentError,
...
pub enum Action {
    ...
    OpenExtensionsModal {
        ...
        trigger: agent_tui_telemetry::events::ExtensionsModalTrigger,
    },
    ...
    AnnouncementsOpenCta(agent_tui_telemetry::events::AnnouncementCtaSurface),
...
pub enum Effect {
    ...
    ScanForeignSessions {
        cwd: std::path::PathBuf,
        compat: agent_tui_workspace::foreign_sessions::EnabledForeignSessionSources,
...
pub enum TaskResult {
    ...
    WorktreeForked {
        ...
        restore_degree: Option<agent_tui_workspace::session::git::RestoreDegree>,
    ...
    ForeignResumeHintDetected {
        canonical_cwd: std::path::PathBuf,
        launch_token: u64,
        hint: Option<agent_tui_workspace::foreign_sessions::RecentForeignSession>,
    },
    ...
    BgTaskKilled {
        session_id: String,
        task_id: String,
        outcome: Option<agent_tui_tools::types::KillOutcome>,
    },
    ...
    ChangelogFetched {
        ...
        entries: Vec<agent_tui_shell::util::changelog::ChangelogEntry>,
    },
    ...
    SessionInfoComplete {
        agent_id: AgentId,
        session_id: acp::SessionId,
        info: Box<agent_tui_shell::session::SessionInfoResponse>,
        text: String,
        nonce: u64,
    },
    ...
    SessionUsageComplete {
        agent_id: AgentId,
        session_id: acp::SessionId,
        usage: Box<agent_tui_shell::extensions::notification::PromptUsage>,
        nonce: u64,
    },
    ...
    GateRefreshed {
        settings: Option<agent_tui_shell::util::config::RemoteSettings>,
    },

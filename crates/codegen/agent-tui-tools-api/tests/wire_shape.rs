...
use agent_tui_tools_api::ToolConfigEntry;
...
fn finalize_request_minimal() -> agent_tui_tools_api::FinalizeToolServerConfigRequest {
    agent_tui_tools_api::FinalizeToolServerConfigRequest {
        tools: vec![],
        truncation: None,
...
fn finalize_request_callback_fields_default_when_absent() {
    let back: agent_tui_tools_api::FinalizeToolServerConfigRequest =

...
/// binary. Once initialized, `agent_tui_config::grok_home()` will resolve to
...
/// Minimal [`agent_tui_update::UpdateConfig`] for install tests.
pub fn make_update_config(channel: &str) -> agent_tui_update::UpdateConfig {
    agent_tui_update::UpdateConfig {

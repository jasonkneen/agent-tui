...
//!
//! ```text
//! # Mirror returns 403 for the @agent-tui scope
...
async fn check_status_surfaces_npm_403_in_error_field() {
    ...
    g.set_stderr(
        "npm error code E403\n\
         npm error 403 403 Forbidden - GET https://registry-mirror.example.invalid/api/npm/js-virtual/@agent-tui%2fagent-tui\n\

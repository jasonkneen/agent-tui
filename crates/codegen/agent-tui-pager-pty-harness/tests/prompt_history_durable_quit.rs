...
//!
//! ```bash
//! cargo test -p agent-tui-pager-pty-harness --test prompt_history_durable_quit \
//!   -- --ignored --nocapture
//! ```
...
use agent_tui_pager_pty_harness::{ContentController, PtyExitPoll, PtyHarness, keys, pager_binary};

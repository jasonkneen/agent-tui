...
//!
//! Run with: cargo test -p agent-tui-mcp --test repro_sse_flood -- --nocapture
...
use agent_tui_mcp::mcp_http_client::{McpHttpClient, WarnBudget};
use agent_tui_mcp::rmcp::ServiceExt;
use agent_tui_mcp::rmcp::transport::StreamableHttpClientTransport;
use agent_tui_mcp::rmcp::transport::streamable_http_client::StreamableHttpClientTransportConfig;

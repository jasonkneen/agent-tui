...
//!
//! Run with: cargo run -p agent-tui-ratatui-textarea --example textarea_demo
//!
...
use agent_tui_ratatui_textarea::wrapping::{RtOptions, word_wrap_line};
use agent_tui_ratatui_textarea::{

...
use agent_tui_tools::implementations::codex;
use agent_tui_tools::implementations::grok_build;
use agent_tui_tools::implementations::grok_build_concise;
...
use agent_tui_tools::implementations::use_tool;
...
pub fn grok_build_hashline_toolset(
    hashline_tools: Vec<agent_tui_tools::registry::types::ToolConfig>,
) -> ToolServerConfig {
    let mut tools: Vec<agent_tui_tools::registry::types::ToolConfig> = vec![bash_tool_config()];
    ...
    pub fn resolve_dir(self, agent_name: &str, project_cwd: &std::path::Path) -> ResolvedMemoryDir {
        match self {
            Self::User => ResolvedMemoryDir {
                path: agent_tui_config::grok_home()
                    .join("agent-memory")
                    .join(agent_name),
...
/// these into `agent_tui_tools::registry::types::ToolsetConfig.bash`
...
impl AgentDefinition {
    ...
    pub fn override_file_tools(
        &mut self,
        file_tools: Vec<agent_tui_tools::registry::types::ToolConfig>,
    ) {
    ...
    pub fn general_purpose() -> Self {
        ...
        Self {
            description: agent_tui_tool_types::GENERAL_PURPOSE_SUBAGENT
                .description
                .to_string(),
    ...
    pub fn explore() -> Self {
        use crate::prompt::subagent_prompts;
        Self {
            description: agent_tui_tool_types::EXPLORE_SUBAGENT.description.to_string(),
    ...
    pub fn plan() -> Self {
        use crate::prompt::subagent_prompts;
        Self {
            description: agent_tui_tool_types::PLAN_SUBAGENT.description.to_string(),
...
mod tests {
    ...
    fn task_tool_rename_matches_task_tool_id_predicate() {
        ...
        assert!(agent_tui_tools::is_task_tool_id(&name));
    }
    /// Native presets only.
    #[test]

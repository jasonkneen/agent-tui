...
use agent_tui_tools::computer::types::{AsyncFileSystem, TerminalBackend};
use agent_tui_tools::notification::ToolNotificationHandle;
use agent_tui_tools::registry::types::SessionContext;
...
/// tool registry in `agent-tui-tools` (also used by the hook matcher).
fn claude_tool_kind(name: &str) -> Option<ToolKind> {
    agent_tui_tools::types::kind_for(name)
}
...
pub struct AgentBuilder {
    ...
    memory_backend: Option<Arc<dyn agent_tui_tools::types::memory_backend::MemoryBackend>>,
    web_search_config: agent_tui_tools::implementations::web_search::WebSearchConfig,
    ...
    attribution_callback: Option<agent_tui_tools::SharedAttributionCallback>,
    ...
    /// `resolve_max_mcp_output_bytes_for_cwd` in agent-tui-shell).
...
fn ensure_plan_mode_tools(tool_config: &mut agent_tui_tools::registry::types::ToolServerConfig) {
...
fn merge_tool_params(
    tool_config: &mut agent_tui_tools::registry::types::ToolServerConfig,
    ids: &[&str],
...
impl AgentBuilder {
    pub fn new(
        ...
        Self {
            ...
            terminal_backend,
            fs_backend: Arc::new(agent_tui_tools::computer::local::LocalFs),
            notification_handle,
            ...
            system_reminder_tag: agent_tui_tools::reminders::DEFAULT_REMINDER_TAG,
    ...
    pub fn with_preloaded_skills(
        mut self,
        skills: Vec<agent_tui_tools::implementations::skills::types::SkillInfo>,
    ) -> Self {
    ...
    pub fn with_memory_backend(
        mut self,
        backend: Arc<dyn agent_tui_tools::types::memory_backend::MemoryBackend>,
    ) -> Self {
    ...
    pub fn with_parent_scheduler_handle(
        mut self,
        handle: agent_tui_tools::implementations::grok_build::scheduler::types::SchedulerHandle,
    ) -> Self {
    ...
    pub fn with_web_search_config(
        mut self,
        config: agent_tui_tools::implementations::web_search::WebSearchConfig,
    ) -> Self {
    ...
    pub fn with_web_fetch_config(
        mut self,
        config: agent_tui_tools::implementations::grok_build::web_fetch::WebFetchConfig,
    ) -> Self {
    ...
    pub fn with_lsp(
        mut self,
        handle: std::sync::Arc<dyn agent_tui_tools::implementations::lsp::LspBackend>,
    ) -> Self {
    ...
    pub fn with_image_gen_config(
        mut self,
        config: agent_tui_tools::implementations::grok_build::image_gen::ImageGenConfig,
    ) -> Self {
    ...
    pub fn with_video_gen_config(
        mut self,
        config: agent_tui_tools::implementations::grok_build::video_gen::VideoGenConfig,
    ) -> Self {
    ...
    pub fn with_app_builder_deployer_config(
        mut self,
        config: agent_tui_tools::implementations::grok_build::deploy_app::AppBuilderDeployerConfig,
    ) -> Self {
    ...
    pub fn with_api_key_provider(
        mut self,
        provider: agent_tui_tools::types::SharedApiKeyProvider,
    ) -> Self {
    ...
    pub async fn build(mut self) -> Result<Agent, AgentBuildError> {
        ...
        if definition.inject_default_tools {
            if self.memory_backend.is_some() {
                use agent_tui_tools::implementations::memory;
                tool_config
                    .tools
            ...
            if self.lsp.is_some() {
                tool_config
                    .tools
                    .push((&agent_tui_tools::implementations::grok_build::LspTool).into());
            }
            if self.image_gen_config.image_gen_enabled() {
                tool_config
                    .tools
                    .push((&agent_tui_tools::implementations::grok_build::ImageGenTool).into());
            }
            if self.image_gen_config.image_edit_enabled() {
                tool_config
                    .tools
                    .push((&agent_tui_tools::implementations::grok_build::ImageEditTool).into());
            }
            if self.video_gen_config.is_enabled() {
                tool_config
                    .tools
                    .push((&agent_tui_tools::implementations::grok_build::ImageToVideoTool).into());
                tool_config.tools.push(
                    (&agent_tui_tools::implementations::grok_build::ReferenceToVideoTool).into(),
                );
            }
            ...
            if self.write_file_enabled && !has_write_tool {
                tool_config
                    .tools
                    .push((&agent_tui_tools::implementations::opencode::OpenCodeWriteTool).into());
            }
            ensure_plan_mode_tools(&mut tool_config);
        }
        if self.memory_backend.is_none() {
            let grok_build_ns = agent_tui_tools::types::tool::ToolNamespace::GrokBuild.to_string();
            let mem_search_id = format!(
                "{grok_build_ns}:{}",
                agent_tui_tools::implementations::memory::MEMORY_SEARCH_TOOL_NAME
            );
            let mem_get_id = format!(
                "{grok_build_ns}:{}",
                agent_tui_tools::implementations::memory::MEMORY_GET_TOOL_NAME
            );
            tool_config
                .tools
        ...
        if !self.ask_user_question_enabled {
            let ask_user_id = format!(
                "{}:ask_user_question",
                agent_tui_tools::types::tool::ToolNamespace::GrokBuild,
            );
        ...
        if task_stripped {
            use agent_tui_tools::types::tool::ToolNamespace;
        ...
        if let agent_tui_tools::implementations::grok_build::web_fetch::WebFetchConfig::Enabled {
            ref params,
        ...
        if let Some(bytes) = self.mcp_max_output_bytes {
            tool_bridge.toolset().resources.lock().await.insert(
                agent_tui_tools::types::resources::TruncationCfg(
                    agent_tui_tools::types::context::TruncationConfig {
        ...
        if use_backend_search {
            if web_search_enabled && definition.hosted_tool_allowed("web_search") {
                hosted_tools.push(agent_tui_sampling_types::HostedTool::WebSearch { options: None });
            }
            if definition.hosted_tool_allowed("x_search") {
                hosted_tools.push(agent_tui_sampling_types::HostedTool::XSearch { options: None });
            }
            agent_tui_sampling_types::apply_tool_overrides(
                &mut hosted_tools,
...
fn resolve_shell_for_prompt() -> String {
    ...
    #[cfg(not(unix))]
    {
        agent_tui_config::shell::detect_windows_shell()
            .name()
            .to_string()
    }
}
...
mod tests {
    ...
    fn entry(name: &str, desc: &str, source: SubagentSource) -> SubagentEntry {
        SubagentEntry {
            ...
            config_source: agent_tui_tools::types::config_source::ConfigSource::Builtin,
        }
    }
    #[test]
    ...
    fn build_task_description_shadowed_builtin_uses_user_desc() {
        let subagents = vec![SubagentEntry {
            ...
            config_source: agent_tui_tools::types::config_source::ConfigSource::Project {
    ...
    fn task_model_guidance_resolves_model_param_override() {
        use agent_tui_tools::types::template_renderer::TemplateRenderer;
        use agent_tui_tools::types::tool::ToolKind;
    ...
    async fn discovery_snapshot_records_gated_and_preloaded_skills() {
        use agent_tui_tools::computer::local::LocalTerminalBackend;
        use agent_tui_tools::notification::ToolNotificationHandle;
    ...
    async fn plan_mode_injected_ask_user_question_receives_params() {
        use agent_tui_tools::computer::local::LocalTerminalBackend;
        use agent_tui_tools::implementations::grok_build::ask_user_question::AskUserQuestionParams;
        use agent_tui_tools::notification::ToolNotificationHandle;
        use agent_tui_tools::types::resources::Params;
    ...
    async fn spawning_blocked_disables_all_background_bash_modes() {
        use agent_tui_tools::computer::local::LocalTerminalBackend;
        use agent_tui_tools::implementations::grok_build::bash::BashParams;
        use agent_tui_tools::notification::ToolNotificationHandle;
        use agent_tui_tools::types::resources::Params;
        let mut definition = crate::config::AgentDefinition::default_grok_build();
    ...
    async fn requested_enabled_web_tools_survive_allowlist() {
        use agent_tui_tools::computer::local::LocalTerminalBackend;
        use agent_tui_tools::implementations::grok_build::web_fetch::WebFetchConfig;
        use agent_tui_tools::implementations::web_search::WebSearchConfig;
        use agent_tui_tools::notification::ToolNotificationHandle;
        let mut definition = crate::config::AgentDefinition::default_grok_build();
    ...
    async fn build_with_web_search(
        ...
        tool_overrides: Option<agent_tui_sampling_types::ToolOverrides>,
    ) -> crate::agent::Agent {
        use agent_tui_tools::computer::local::LocalTerminalBackend;
        use agent_tui_tools::implementations::web_search::WebSearchConfig;
        use agent_tui_tools::notification::ToolNotificationHandle;
    ...
    async fn disallowed_web_search_strips_function_and_hosted_tools() {
        ...
        assert!(
            !hosted
                .iter()
                .any(|t| matches!(t, agent_tui_sampling_types::HostedTool::WebSearch { .. })),
            "hosted WebSearch must be removed when web_search is disallowed, got: {hosted:?}"
        );
        assert!(
            hosted
                .iter()
                .any(|t| matches!(t, agent_tui_sampling_types::HostedTool::XSearch { .. })),
    ...
    async fn hosted_tools_bake_definition_tool_overrides_into_options() {
        let x_search = agent_tui_sampling_types::XSearchOptions {
            date_bound: Some(
                agent_tui_sampling_types::SearchDateBound::new(None, Some("2024-03-15".into()))
                    .unwrap(),
            ),
        };
        let agent = build_with_web_search(
            ...
            true,
            &[],
            Some(agent_tui_sampling_types::ToolOverrides {
        ...
        assert!(
            agent
                .hosted_tools()
                .contains(&agent_tui_sampling_types::HostedTool::XSearch {

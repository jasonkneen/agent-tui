...
///
/// Delegates to [`agent_tui_tools::util::substitute_plugin_tokens`], the single
...
pub fn substitute_env_vars(s: &str, plugin_root: &str, plugin_data: &str) -> String {
    agent_tui_tools::util::substitute_plugin_tokens(s, Some(plugin_root), Some(plugin_data))
}

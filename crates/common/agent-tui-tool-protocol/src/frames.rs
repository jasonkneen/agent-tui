...
pub struct ToolCallResult {
    ...
    /// this crate must not depend on `agent-tui-tool-runtime`. Sampler-side wire
...
/// `agent_tui_computer_hub_core::registry::ToolSessionBindOutcome`, with one
...
pub struct ToolsListResult {
    pub tools: Vec<agent_tui_tool_types::ToolDescription>,
}

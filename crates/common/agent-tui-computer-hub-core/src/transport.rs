...
//!
//! [`TransportKind`] is re-exported from [`agent_tui_tool_protocol`] so the wire
...
use agent_tui_tool_protocol::{SessionId, ToolId, UserId};
use agent_tui_tool_runtime::{ToolCallContext, ToolError, ToolStream, TypedToolOutput};

pub use agent_tui_tool_protocol::TransportKind;

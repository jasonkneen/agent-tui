...
fn map_block(block: agent_tui_tool_protocol::McpBlock) -> ContentBlock {
    use agent_tui_tool_protocol::McpBlock;
    match block {
...
pub fn error_from_envelope(err: agent_tui_tool_protocol::JsonRpcError) -> ToolError {

...
use serde_json::json;
use agent_tui_computer_hub_core::{error_from_envelope, tool_error_from_wire};
use agent_tui_tool_protocol::{JsonRpcError, RequestId, ToolErrorWire};
use agent_tui_tool_runtime::ToolErrorKind;
